...
= How can i get support if my Lead form builder is not Working ? =

If you're facing any problem while using our Lead form builder plugin, Please first follow the below steps :
1. Deactivate all plugins you are using and check if the problem is still occurring with our Lead form builder .
...
= Is is compatible with all Wp Themes ? =

It is compatible with all [ThemeHunk themes](https://themehunk.com/free-themes/) and almost all WordPress themes, We always try to make our Plugin compatible with All WordPress Themes. If Leadform Builder will create any kind of issue with any theme. You're Free to [contact us](https://themehunk.com/contact-us/) , Our Team will be Happy to help you.

= How can i get more advanced features of Lead form Builder Pro ? =

You can get more features with the premium version of Leadform Builder Plugin, available on [ThemeHunk themes](https://themehunk.com/free-themes/). Please [follow this link](https://wpthemes.themehunk.com/lead-form-builder-pro/) and get to know about more advanced features.


= Can I translate Leadform Builder plugin to Multi Language ? =

Yes, You can translate our plugin to desired language.

= How to Install Plugin =
Just upload the `lead-form-builder.zip` to the `/wp-content/plugins/` directory, and then activate it from 'Plugins' menu in WordPress.

1. [Docs](http://www.themehunk.com/docs/lead-form/)
2. [Support Forum](https://www.themehunk.com/support/#plugin.25)
...
= Version 1.9.2 =
* Fix: Vulnerability - Authenticated issue fixed .

= Version 1.9.1 =
* Update: use of current_user_can() function.
...
* Fix : Plugin image issue fixed.

= Version 1.8.6 =
* Fix: Year range extended in date range.

= Version 1.8.5 =
* Fix: Ajax vulnerability issue fixed.

= Version 1.8.4 =
* Fix: Ajax nonce issue fixed.
...
= Version 1.7.5 =
* New Option panel update.
* Dashboard style fixed.

= Version 1.7.4 =
* AJAX missing CSRF & auth issue fixed.

= Version 1.7.3 =
* Data save user permission and nonce bug fixed.
* TH shop mania banner added.

= Version 1.7.2 =
* Sanitized issue fixed.
* Style improove.
...
* Subscriber+ Arbitrary Lead Deletion issue fixed.

= Version 1.6.3 =
* Improve Text.

= Version 1.6.2 =
* date range issue fixed.
...
= Version 1.3.11 =
* New screenshot changes.
* All builder compatible issue fixed.
...
= Version 1.3.4 =
* Insert and update form stripslash issue fixed.

= Version 1.3.3 =
* Term & condition checkbox added.

= Version 1.3.2 =
* Reply mail issue fixed.

= Version 1.3.1 =
* Form width issue fixed.
* Backend style issue fixed.

= Version 1.3.0 =
* This update introduce completely different user interface. 
* Note : Some major changes have done in the database. So please backup your leads before updating plugin. And also edit existing forms and save them again.
* css style changes.
* bug fixed.
...
= Version 1.1.6 =
 * pluggable issue fixed and remove.

= Version 1.1.5 =
 * Admin email subject issue fixed

= Version 1.1.4 =
 * Submit button text issue fixed.

= Version 1.1.3 =
* Backend save error issue fixed.
* Submit text change issue fixed.
* Js conflict issue fixed. 

= Version 1.1.2 =
* View form issue fixed.

= Version 1.1.1 =
* form submit issue fixed.
* firefox drag and drop issue fixed.
* improove styles.
...
= Version 1.0.9 =
* mum form create issue fixed.
* number field style issue fixed.
...
= Version 1.0.1 =
* Screenshot and thumbnail added.
