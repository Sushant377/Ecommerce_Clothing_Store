    ...
    public function plugin_action_links($actions)
    {
        $new_actions = array(
            'settings' => '<a href="'
                . esc_url(
                    admin_url(
                        'admin.php?page=wc-settings&tab=checkout&section=khalti'
                    )
                )
                . '" aria-label="'
                . esc_attr(
                    __('View WooCommerce Khalti settings', 'woocommerce-khalti')
                ) . '">'
    ...
    public function woocommerce_missing_notice()
    {
        echo '<div class="error notice is-dismissible"><p>'
            . sprintf(
                ...
                esc_html__(
                    'Integrate Khalti in WooCommerce depends on %s or later to work!',
                    'woocommerce-khalti'
                ),
                '<a href="http://www.woothemes.com/woocommerce/" target="_blank">'
                    . esc_html__('WooCommerce 4.5', 'woocommerce-khalti') . '</a>'
            ) . '</p></div>';
    }
}
