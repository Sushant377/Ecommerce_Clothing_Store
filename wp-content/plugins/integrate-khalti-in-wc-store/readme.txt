...
The manual installation method involves downloading our Integrate Khalti in WC Store plugin and uploading it to your webserver via your favourite FTP application. The WordPress codex contains [instructions on how to do this here](https://codex.wordpress.org/Managing_Plugins#Manual_Plugin_Installation).
...
Bugs can be reported either in our support forum or preferably on the [WooCommerce Khalti GitHub repository](https://github.com/khalti/woocommerce-plugin-kpg-2/issues). You can directly reach our developers at developers@act360.com.np
