...
if (!function_exists('themehunk_admin_menu')) {
  ...
  define('THEMEHUNK_PDIR', plugin_dir_path(__FILE__));
    ...
    function themehunk_admin_menu(){
            add_menu_page(__('ThemeHunk', 'taiowc'), __('ThemeHunk', 'taiowc'), 'manage_options', 'themehunk-plugins', 'themehunk_plugins',  THEMEHUNK_PURL . '/th-option/assets/images/ico.png', 59);
        }
