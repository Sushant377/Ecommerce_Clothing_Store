...
if (!function_exists('unlimited_blocks_post_image_three_post')) {
    function unlimited_blocks_post_image_three_post()
    {
        if (isset($_POST['attr']) && is_array($_POST['attr'])) {
            ...
            if (isset($attr['numberOfPosts']) && intval($attr['numberOfPosts'])) {
                ...
                echo unlimited_blocks_post_image_three_post_html($args, $attr) ? unlimited_blocks_post_image_three_post_html($args, $attr) : 0;
                die();
            }
        }
    }
    add_action('wp_ajax_unlimited_section_post_image_three_post', "unlimited_blocks_post_image_three_post");
    add_action('wp_ajax_nopriv_unlimited_section_post_image_three_post', "unlimited_blocks_post_image_three_post");
}
// return html function
if (!function_exists('unlimited_blocks_post_image_three_post_html')) {
    function unlimited_blocks_post_image_three_post_html($args, $attr)
    {
